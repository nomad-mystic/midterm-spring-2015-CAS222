...
// Define Canvas and Initialize
	if(isCanvasSupported){
		...
		var cw = c.width;
		var ch = c.height;	
		document.body.childNodes[1].childNodes[4].appendChild(c);	
...
// Create Click event to stop and start the audio 
	$('.soundControl').on('click', function(evnt) { 
		...
		var music = evnt.view.document.body.childNodes[12];
...
// This is going to be the function that starts and stops audio and video 
	$('.videoAudioControl').on('click', function(evnt) {
		...
		var music = evnt.view.document.body.childNodes[12];
		var video = evnt.view.document.body.childNodes[1].childNodes[4].childNodes[9].childNodes[1];
